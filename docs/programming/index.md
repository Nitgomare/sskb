...
<header class="learning-hub__hero">
  ...
  <h1>编程与人工智能学习中心</h1>
  <p>为研究生整理的三条渐进式路径：先建立数据处理能力，再掌握经典机器学习，最后进入可复现的深度学习实验。</p>
  <div class="learning-hub__meta"><span>3 条独立路径</span><span>课程 + 教材</span><span>面向科研实践</span></div>
</header>
...
<div class="learning-paths">
  <a class="learning-path learning-path--python" href="../book-sites/python-data-analysis/" target="_top">
    <span class="learning-path__number">01 · FOUNDATION</span>
    <h2>Python 数据分析</h2>
...
<div class="learning-sequence">
  <div><b>1</b><span><strong>能处理数据</strong><small>Python → NumPy → Pandas → 可视化</small></span></div>
  <i>→</i>
  <div><b>2</b><span><strong>理解模型</strong><small>评估 → 经典算法 → 理论边界</small></span></div>
  <i>→</i>
  <div><b>3</b><span><strong>完成实验</strong><small>PyTorch → 训练 → 复现 → 报告</small></span></div>
</div>
