...
<img src="images/00001.jpeg" class="zaozi" />
...
笔者自认才疏学浅，仅略知皮毛，更兼时间和精力所限，书中错谬之处在所难免，若蒙读者诸君不吝告知，将不胜感激。
...
## 如何使用本书 <span class="yinwen">——写在第十次印刷之际</span>
...
<img src="images/00002.jpeg" class="zaozi1" />　样本空间或状态空间

<img src="images/00003.jpeg" class="zaozi1" />　概率分布

D　数据样本（数据集）

<img src="images/00004.jpeg" class="zaozi1" />　假设空间

H　假设集

<img src="images/00005.jpeg" class="zaozi1" />　学习算法
...
‖·‖<sub>p</sub>　L<sub>p</sub>范数，p缺省时为L<sub>2</sub>范数

P（·）, P（·\|·）　概率质量函数，条件概率质量函数

p（·）, p（·\|·）　概率密度函数，条件概率密度函数

<img src="images/00006.jpeg" class="zaozi1" />·∼<img src="images/00003.jpeg" class="zaozi1" />\[f（·）\]　函数f（·）对·在分布<img src="images/00003.jpeg" class="zaozi1" />下的数学期望；意义明确时将省略<img src="images/00003.jpeg" class="zaozi1" />和（或）·

sup（·）　上确界

I（·）　指示函数，在·为真和假时分别取值为1，0
